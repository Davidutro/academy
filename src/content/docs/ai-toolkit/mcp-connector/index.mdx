...
Note: currently this setting is not available in the moble app, but can be congigured in Claude.ai / Claude Desktop and then used in the mobile app.
...
3. Specify the name as **Santiment** and remote URL as `https://api.santiment.net/mcp` and click Add.
...
Note: currently this setting is not available in the moble app, but can be congigured in chatgpt.com and then used in the mobile app.
...
4. Specify the name as **Santiment**, MCP Server URL as `https://api.santiment.net/mcp`, Authentication as `OAuth`, confirm security risk warning and click Create.
5. You'll be redirected to Santiment to authorize access via OAuth.
6. Log in (or create a free account at [app.santiment.net](https://app.santiment.net)) and approve the connection.
7. Open new chat, click "+" button and select "Santiment" from the list of connectors/apps. Start asking questions about any token, metric, or market condition.
