...
2. In customize section you will find connectors, in connectors choose `Santiment Connector`.
3. In `Remote MCP server URL` paste:
   ...
   Then click `Add`.
4. Start asking questions about any token, metric, or market condition.
