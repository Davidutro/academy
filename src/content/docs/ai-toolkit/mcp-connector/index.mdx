...
Note: at time of writing, this setting is not available in the mobile app, but can be configured in chatgpt.com and then used in the mobile app.

1. In ChatGPT, go to Settings → Plugins.
2. Enable Developer Mode (if necessary).
3. Click Create Plugin.
4. Enter our MCP server URL: https://api.santiment.net/mcp
5. Authenticate using 0Auth.
...
- Website: [santiment.net](https://santiment.net?utm_source=academy)
