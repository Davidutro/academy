...
## Santiment's Model Context Protocol (MCP) Connector

A simple path. No difficult setup, no code, no terminal.

Connect Santiment to Claude:
...
[Visit this page](https://academy.santiment.net/mcp-connector) for use case examples, available tools, and even more info.
