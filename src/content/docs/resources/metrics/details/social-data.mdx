...
By **social data**, we mean a set of crypto-related discussions from the
...
run full-text search queries on top of it very quickly.
...
separate the incoming data by asset, i.e., the metrics we build on top of the
...
Twitter social volume is also available broken down by account category —
see [Categorized Social Volume](/metrics/social-volume-categorized).
