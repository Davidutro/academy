...
## Description
Gas fees are the fees paid for the computational effort required to execute a transaction or
...
$$
- 'network_circulation_usd_1d': Total value in USD of all coins moved on Ethereum
