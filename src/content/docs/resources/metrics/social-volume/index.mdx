...
Twitter social volume can be broken down further by account category — see
...
We constantly update our labels, which helps us keep labels as fresh as possible but results in historical data changes. Any modifications to labels, social sources, or relevant jobs will prompt recalculation for the previous month's data. Within a 12-hour period, the metric can be supplemented with new data.
...
Social Volume from all sources for an asset can be seen on the [Charts Tool](https://app.santiment.net/charts).

Social Volume for arbitrary search terms and combinations of them can be viewed from the [My Narratives Tool](https://app.santiment.net/social-trends/my-narratives)

![Social volume for a custom search term](./social-volume-search-term.png)

Social volume from specific sources are displayed below the primary chart.
...
Twitter social volume is further split by account category — see
[Categorized Social Volume](/metrics/social-volume-categorized).
